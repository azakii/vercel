...
function SectionMarketingGallery({
    ...
    const expImages = images.map((singleImage) => {
        return {
            ...
            src:
                singleImage.url +
                `${type === 'img' ? '-/preview/-/quality/lightest/' : ''}`,
            thumbnail:
                singleImage.url + `${type === 'img' ? '-/preview/80x80/' : ''}`,
            ...
            <div
                ...
                <div className="hidden md:grid md:h-72 lg:h-96 xl:h-128 d-hdpi-2:h-vw-128 mt-vw-1.5 overflow-hidden rounded-xl d-hdpi-2:rounded-vw-xl w-full gap-2 grid-rows-4 grid-cols-8 grid-flow-col relative d-hdpi-2:gap-1">
                    <ImageHover
                        ...
                        url={`${expImages[1]?.src}${
                            type === 'img'
                                ? '-/scale_crop/480x640/smart_objects_faces_points/'
                                : ''
                        }`}
                    ...
                    <ImageHover
                        ...
                        url={`${expImages[2]?.src}${
                            type === 'img'
                                ? '-/scale_crop/240x320/smart_objects_faces_points/'
                                : ''
                        }`}
                        handleActionBtn={lightBoxHandler}
                        params={[2]}
                    ...
                    <ImageHover
                        ...
                        url={`${expImages[3]?.src}${
                            type === 'img'
                                ? '-/scale_crop/480x320/smart_objects_faces_points/'
                                : ''
                        }`}
                        handleActionBtn={lightBoxHandler}
                        params={[3]}
                ...
                <div className="md:hidden h-96 overflow-hidden rounded-xl w-full grid gap-1 d-hdpi-2:gap-0.5 grid-rows-4 grid-cols-6 grid-flow-col relative">
                    <ImageHover
                        url={`${expImages[0]?.src}${
                            type === 'img'
                                ? '-/scale_crop/480x480/smart_objects_faces_points/'
                                : ''
                        }`}
                        handleActionBtn={lightBoxHandler}
                        params={[0]}
                    ...
                    <ImageHover
                        url={`${expImages[1]?.src}${
                            type === 'img'
                                ? '-/scale_crop/320x320/smart_objects_faces_points/'
                                : ''
                        }`}
                        handleActionBtn={lightBoxHandler}
                        params={[1]}
